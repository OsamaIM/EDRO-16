/*  ================================================================
    main.cpp  -  Continuous Balanced Bipedal Normal Walking
    ================================================================
...
// ════════════════════════════════════════════════════════════════
int HIP_SWING_DEG   = 12;    // how far hip pitches forward/back(slow walk 8)
int KNEE_LIFT_DEG   = 14;   // how much knee bends to lift foot
int HIP_ROLL_DEG    = 2;    // lateral weight-shift amount(slow walk 8)
int ANKLE_COMP_DEG  = 1;    //ankle compensation during weight-shift(slow walk 4)
...
// ════════════════════════════════════════════════════════════════
int PHASE_STEPS  = 12;   // interpolation steps per phase (smoothness)
int PHASE_SPEED  = 8;   // ms delay between each interpolation step
int PHASE_DELAY  = 20;   // ms pause after each phase completes
